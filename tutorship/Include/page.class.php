<?php  
 ...
 class Page {  
      ...
      */  
     function __construct($each_disNums, $nums, $current_page, $sub_pages,$dataName) {  
         ...
         $this->subPage_link =$_SERVER['PHP_SELF']."?dataName=".$dataName."&page=";
     }  
     /** 
      * 照顾低版本 
      */  
 ...
 */  
     ...
     */  
     function subPageCss2() {  
        ...
        if ($this->current_page > 1) {  
             $firstPageUrl = $this->subPage_link . "1";  
             $prewPageUrl = $this->subPage_link . ($this->current_page - 1);  //上一页
